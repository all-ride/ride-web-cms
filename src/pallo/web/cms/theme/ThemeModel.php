...
use pallo\library\cms\theme\TemplateThemeModel;
...
class ThemeModel extends TemplateThemeModel {
     ...
     * @var pallo\library\cms\layout\LayoutModel;
     */
     ...
     * @param pallo\library\template\theme\ThemeModel $model Instance of the
     * template theme model
     * @param pallo\library\cms\layout\LayoutModel $layoutModel Instance
     * of the layout model
     * @param pallo\library\system\file\File $directory Directory to write
     * dummy templates
     * @return null
     */
